...
func setupAuthRouter(t *testing.T) (http.Handler, *captureSender) {
	...
	return newRouter(healthSvc, svc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, false, "http://localhost:3000", observability.NewHTTPMetrics(nil), nil), sender
}
