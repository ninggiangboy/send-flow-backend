...
func setupFullAPIRouter(t *testing.T) http.Handler {
	...
	return newRouter(healthSvc, nil, nil, audienceSvc, contentSvc, suppressionSvc, nil, nil, nil, nil, false, "http://localhost:3000", observability.NewHTTPMetrics(nil), slog.Default())
}
