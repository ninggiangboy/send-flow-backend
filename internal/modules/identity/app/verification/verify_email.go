...
func NewVerifyEmailHandler(opts VerifyEmailOptions) *VerifyEmailHandler {
...
func (h *VerifyEmailHandler) Execute(ctx context.Context, token string, now time.Time) error {
