...
func NewAcceptInvitationHandler(opts AcceptInvitationOptions) *AcceptInvitationHandler {
...
func (h *AcceptInvitationHandler) Execute(ctx context.Context, cmd AcceptInvitationCommand) (*domain.Membership, error) {
