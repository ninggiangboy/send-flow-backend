...
func NewInviteHandler(opts InviteOptions) *InviteHandler {
...
func (h *InviteHandler) Execute(ctx context.Context, cmd InviteCommand) (*InviteResult, error) {
	...
	persistInvitation := func(txCtx context.Context) error {
		...
		if err := shared.EmitEvent(txCtx, h.outboxWriter, h.idGen, contracts.EventWorkspaceMemberInvitedV1, "invitation", invitation.ID, cmd.WorkspaceID, payload, cmd.Now); err != nil {
