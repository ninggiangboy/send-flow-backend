...
func NewTOTPEnableHandler(opts TOTPEnableOptions) *TOTPEnableHandler {
	return &TOTPEnableHandler{
		totp:            opts.Totp,
...
func (h *TOTPEnableHandler) Execute(ctx context.Context, userID, code string, now time.Time) (*TOTPEnableResult, error) {
	...
	return &TOTPEnableResult{RecoveryCodes: recoveryCodes}, nil
}
