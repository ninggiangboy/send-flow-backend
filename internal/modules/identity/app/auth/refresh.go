...
func NewRefreshHandler(opts RefreshOptions) *RefreshHandler {
...
func (h *RefreshHandler) Execute(ctx context.Context, cmd RefreshCommand) (*shared.SessionContext, error) {
	...
	return &shared.SessionContext{Session: *sess, User: *user, Tokens: tokens}, nil
}
