...
type ProcessDueMessagesHandler struct {
...
func NewProcessDueMessagesHandler(
	messagesWrite ports.MessageWriteRepository,
	attemptsWrite ports.AttemptWriteRepository,
	retryStatesWrite ports.RetryStateWriteRepository,
	senderChecker ports.SenderReadinessChecker,
	...
	attachmentRepo ports.AttachmentRepository,
	objectStorage ports.ObjectStorage,
) *ProcessDueMessagesHandler {
	return &ProcessDueMessagesHandler{
...
func (h *ProcessDueMessagesHandler) ProcessDueMessagesAllWorkspaces(ctx context.Context, input ProcessDueMessagesAllInput) (int, error) {
...
func (h *ProcessDueMessagesHandler) ProcessDueMessages(ctx context.Context, input ProcessDueMessagesInput) (*ProcessDueMessagesResult, error) {
...
func (h *ProcessDueMessagesHandler) processMessage(ctx context.Context, msg domain.Message, now time.Time) (messageStatus, error) {
...
func (h *ProcessDueMessagesHandler) writeEvent(ctx context.Context, msg domain.Message, eventType, status, reasonCode, reasonMessage string, now time.Time) {
	if h.eventRepo == nil {
		return
	}
	eventID, err := h.idGen()
...
func (h *ProcessDueMessagesHandler) failMessage(ctx context.Context, msg domain.Message, now time.Time, errorClass, errorMessage string) {
	msg.FailedAt = &now
...
func (h *ProcessDueMessagesHandler) failMessageWithAttempt(ctx context.Context, msg domain.Message, attempt domain.DeliveryAttempt, now time.Time, errorClass, errorMessage string) {
...
func (h *ProcessDueMessagesHandler) handleTemporaryFailure(ctx context.Context, msg domain.Message, attempt domain.DeliveryAttempt, now time.Time, providerErr error) {
...
func (h *ProcessDueMessagesHandler) persistAcceptedState(ctx context.Context, msg domain.Message, attempt domain.DeliveryAttempt, providerResult *ports.ProviderSendResult, now time.Time) error {
	eventID, err := h.idGen()
	if err != nil {
...
func (h *ProcessDueMessagesHandler) saveAcceptedEvent(ctx context.Context, msg domain.Message, providerResult *ports.ProviderSendResult, now time.Time, eventID string) error {
...
func (h *ProcessDueMessagesHandler) saveRetryScheduledEvent(ctx context.Context, msg domain.Message, retryState *domain.RetryState, now time.Time) error {
	eventID, err := h.idGen()
	if err != nil {
		return err
	}
...
func (h *ProcessDueMessagesHandler) loadAttachments(ctx context.Context, msg domain.Message) ([]ports.AttachmentPart, error) {
