...
func NewScheduleHandler(opts ScheduleOptions) *ScheduleHandler {
...
func (h *ScheduleHandler) Execute(ctx context.Context, cmd ScheduleInput) (*ScheduleResult, error) {
	...
	return &ScheduleResult{Campaign: campaign, Candidates: candidates}, nil
}
