...
func NewStart(opts StartOptions) *StartHandler {
	return &StartHandler{
...
func (h *StartHandler) Execute(ctx context.Context, cmd StartCommand) (*domain.AudienceExportJob, error) {
...
func (h *StartHandler) estimateTotalCount(ctx context.Context, cmd StartCommand) (int64, error) {
