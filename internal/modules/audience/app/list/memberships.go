...
type UpdateMembershipsOptions struct {
	ListsWrite    ports.ListWriteRepository
	AccessChecker ports.WorkspaceAccessChecker
	Logger        *slog.Logger
}

type UpdateMembershipsCommand struct {
	WorkspaceID string
	ListID      string
	UserID      string
	Mode        string
...
type UpdateMembershipsHandler struct {
	listsWrite    ports.ListWriteRepository
	accessChecker ports.WorkspaceAccessChecker
	log           *slog.Logger
}

func NewUpdateMemberships(opts UpdateMembershipsOptions) *UpdateMembershipsHandler {
	return &UpdateMembershipsHandler{
...
func (h *UpdateMembershipsHandler) Execute(ctx context.Context, cmd UpdateMembershipsCommand) (*domain.MembershipUpdateResult, error) {
