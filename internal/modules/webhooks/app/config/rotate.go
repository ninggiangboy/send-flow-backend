...
func NewRotate(opts RotateOptions) *RotateHandler {
...
func (h *RotateHandler) Execute(ctx context.Context, cmd RotateCommand) (*RotateResult, error) {
	...
	return &RotateResult{Config: *cfg, RawSecret: rawSecret, Hint: hint}, nil
}
