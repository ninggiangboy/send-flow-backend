...
func (h *Handler) recordDeliveryOutcome(ctx context.Context, delivery *domain.WebhookDelivery, cfg *domain.WebhookConfig, attemptNumber int, result *deliverwebhook.Result) (string, error) {
...
func (h *Handler) emitDeliveryOutcome(ctx context.Context, delivery *domain.WebhookDelivery, cfg *domain.WebhookConfig, result *deliverwebhook.Result, outcome string, nextAttemptAt *time.Time) error {
