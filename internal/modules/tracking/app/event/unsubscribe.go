...
func NewUnsubscribe(opts UnsubscribeOptions) *UnsubscribeHandler {
	if opts.Logger == nil {
...
func (h *UnsubscribeHandler) Execute(ctx context.Context, input UnsubscribeInput) (*UnsubscribeResult, error) {
